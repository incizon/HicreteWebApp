...
class OutwardData extends CommonMethods{
 ...
 public function insertOutwardInToDb($dbh,$userId) { 
    $materialId=56;
    try{
      ...
      $stmtOutward->bindParam(':warehouseid', $userId, PDO::PARAM_STR, 10);
      $stmtOutward->bindParam(':companyid', $userId, PDO::PARAM_STR, 10);
      $stmtOutward->bindParam(':supervisorid', $userId, PDO::PARAM_STR, 10);
      ...
      if($stmtOutward->execute()){
          ...
          $stmtOutwardDetails->bindParam(':materialid', $this->material, PDO::PARAM_STR, 10);
          $stmtOutwardDetails->bindParam(':quantity', $this->materialQty, PDO::PARAM_STR, 40);
          $stmtOutwardDetails->bindParam(':packagedunits', $this->packageUnit, PDO::PARAM_STR, 10);
          ...
          if($stmtOutwardDetails->execute()){
             ...
             if($this->hasTransportDetails=='Yes'){
              ...
              if($stmtTransportDetails->execute()){
                  $lastTransportId=$dbh->lastInsertId();
                              //MAP PURCHASE ORDER TO Outward ENTRY HERR
             ...
             // I CAN OPTIMIZE THIS CODE
              ...
              $result=null;
                ...
                $stmtInventoryCount->bindParam(':materialid', $this->material, PDO::PARAM_STR, 10);
