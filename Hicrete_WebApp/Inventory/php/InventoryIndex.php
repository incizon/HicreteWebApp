...
function inwardOperations($pOperation, $pData)
{
    ...
    switch ($pOperation) {
        ...
        case 'search':
            ...
            break;
        case 'getunitofmeasure':
            //echo $pData->inwardData->material;
            InwardData::getUnitOfMeasure($dbh,$pData->inwardData->material);
            break;
        default:
...
function getProductsForOutward(){
    ...
    $stmt = $dbh->prepare("SELECT * FROM product_master
                ...
                JOIN material ON
                product_master.productmasterid=material.productmasterid
                 JOIN inventory ON inventory. materialid=material.materialid");
